...
export default function Reasons(){
  ...
  return (
    ...
    <div className=" place-self-center col-span-2 mx-5 ">
      <h2 className="font-bold text-2xl tracing-wide leading-10">Why Us?</h2>
      ...
      <div className="col-span-2  tracking-wide leading-loose"> <img src={one} alt={"rari"}></img>
    </div>
  </div>
  )
}